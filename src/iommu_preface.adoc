...
[.big]*_Preface to Version 20240615_*

Chapters 2 through 8 of this document form the RISC-V IOMMU Base Architecture
Specification. Chapter 8 includes the standard extensions to the base
architecture. This release, version 20240615, contains the following versions
