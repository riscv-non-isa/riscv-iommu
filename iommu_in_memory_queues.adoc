...
as determined by `fctrl.END` (<<FCTRL>>).
...
address translation. If bit 0 of `iotval2` is 1, and the implicit memory access
was a write then bit 1 of `iotval2` is set to 1 else it is set to 0.
