...
as they use the CXL.cache protocol to implement caches tagged by tagged by the
translated address returned in response to a PCIe ATS Translation Request. The
IOMMU may not be invoked for translating the addresses in CXL.cache transactions.
====
