...
When second-stage address translation is not Bare, the `PPN` field holds a
...
When second-stage address translation is not Bare, the `PPN` field holds a guest
...
.. Let `iohgatp` be the value in the `DC.iohgatp` field
. If second-stage address translation is Bare, then use the process
...
. If second-stage address translation is not Bare then use the process specified
...
. If second-stage address translation is not Bare then use the
