...
are implementation-specific. The partitioning of the responsibility between
the IOMMU and the IO bridge for recording of the incoming MSI in an MRIF and the
generation of the associated _notice_ MSI are implementation-specific.
