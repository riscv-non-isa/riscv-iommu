...
=== Reset behavior
The reset default value is 0 for the following registers. Reset value is 
implementation-defined for all other registers and/or fields.
...
|63:60 |`iommu_mode` |RW     a| The IOMMU may be configured to be in following
                                modes:
