...
|14:0   |`eventID`  |WARL      | Indicates the event to count. 
                                 ...
                                 Encodings 16384 to 32767 are for custom use and
...
| 0 | Do not count | 
| 1 | Untranslated requests at device interface | 0
| 2 | Translated requests at device interface | 0
| 3 | ATS Translation requests at device interface | 0
