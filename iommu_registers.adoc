...
|0    |`cqen`  |RW        | The command-queue-enable bit enables the command-
                            ...
                            the `cqcsr` bits `cmd_ill`, `cmd_to`, `cqmf`,
...
|0     |`fqen`|RW        | The fault-queue enable bit enables the fault-queue 
                           when set to 1. +
                                                                               +
                           Changing `fqen` from 0 to 1, resets the `fqh` to 0.
                           ...
                           off, the `fqon` bit reads 0 and the `fqcsr` bits 
                           `fqof`, and `fqmf` are set to 0. +
                                                                               +
...
|0     |`pqen`   |RW        | The page-request-enable bit enables the
                              ...
                              to 0 and clears `pqcsr` bits `pqmf` and
                              ...
                              the `pqon` bit reads 0 and the `pqcsr` bits `pqof`,
                              and `pqmf` are set to 0. +
                                                                               +
