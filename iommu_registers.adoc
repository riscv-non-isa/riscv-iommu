...
|0    |`cqen`  |RW        | The command-queue-enable bit enables the command-
                            ...
                            the `cqh`, `cqt` and the `cqcsr` bits `cmd_ill`,
                            `cmd_to`, `cqmf`, `fence_w_ip` are set to 0.
                            The command-queue may take some time to be
                            active following setting the `cqen` to 1. When the
...
|0     |`fqen`|RW        | The fault-queue enable bit enables the fault-queue 
                           when set to 1. +
                                                                               +
                           Changing `fqen`  from 0 to 1, sets the `fqh`, `fqt`,
                           and the `fqcsr` bits `fqof`, and `fqmf` to 0.
