...
|600   |`tr_req_iova`   |8   |<<TRR_IOVA, Translation-request IOVA>>
|608   |`tr_req_ctrl`   |8   |<<TRR_CTRL, Translation-request control>>
|616   |`tr_response`   |8   |<<TRR_RSP, Translation-request response>>
|624   |Reserved        |58  |Reserved for future use (`WPRI`)
...
|36:31 |`PAS`      |RO        | Physical Address Size (value between 32 and 56)
|47:37 | reserved  |RO        | Reserved for standard use
...
|31:16 |_custom_   |          | _Reserved for custom use._
|===
...
|31:28 |_custom_|        | _Reserved for custom use._
|===
[NOTE]
====
...
|15:8   |_custom_|          | _Reserved for custom use._
...
[NOTE]
====
A minimum of one progammable event counter besides the cycles counter is 
...
| 0     |`Go/Busy`  |RW1S      | This bit is set to indicate a valid 
                                 ...
                                 of the translation are in `tre_response`
                                 register.
...
| 59:40 |`DID`      |WARL      | When `PV` is 1 this field provides the
                                 `process_id` for this translation 
                                 request.
| 63:60 a|_custom_ |WARL      a| _Reserved for custom use_
|===
