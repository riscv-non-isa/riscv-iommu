...
the `REV8` byte-reversal instruction defined by the RISC-V "Bitmanip" extension
(B extension). If `REV8` is not implemented, then endianness conversion may be
...
|47    |`fault`  |RO          | If the process to translate the IOVA detects
                                ...
                                fault-queue.
|59:48 |reserved |RO          | Reserved for standard use
